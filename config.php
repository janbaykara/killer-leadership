...
class App {
  ...
  */ 
      ...
      */
          // Project strings
          $this->PUBLISHER      = "Jan Baykara";
          $this->PROJECTNAME    = "Killer Leadership";
          $this->DESCRIPTION    = "In a world where ruthless dictators still reign supreme..."; // No longer than 155 characters.
